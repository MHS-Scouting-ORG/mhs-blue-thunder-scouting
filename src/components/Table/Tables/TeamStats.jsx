...
function TeamStats(props) {
  ...
  return (
    ...
    <button onClick={() => tableColumns.find((e) => e.Header === "AVG CORALL1 MIS") === undefined ? setTableColumns(tableColumns.concat([{Header: "AVG CORALL1 MIS", accessor: "AvgMissedCoralL1"}])) : setTableColumns(tableColumns.filter((x) => x.Header !== "AVG CORALL1 MIS"))}>AVG CORALL1 MIS</button>
    <button onClick={() => tableColumns.find((e) => e.Header === "AVG CORALL2 MIS") === undefined ? setTableColumns(tableColumns.concat([{Header: "AVG CORALL2 MIS", accessor: "AvgMissedCoralL2"}])) : setTableColumns(tableColumns.filter((x) => x.Header !== "AVG CORALL2 MIS"))}>AVG CORALL2 MIS</button>
    <button onClick={() => tableColumns.find((e) => e.Header === "AVG CORALL3 MIS") === undefined ? setTableColumns(tableColumns.concat([{Header: "AVG CORALL3 MIS", accessor: "AvgMissedCoralL3"}])) : setTableColumns(tableColumns.filter((x) => x.Header !== "AVG CORALL3 MIS"))}>AVG CORALL3 MIS</button>
    <button onClick={() => tableColumns.find((e) => e.Header === "AVG CORALL4 MIS") === undefined ? setTableColumns(tableColumns.concat([{Header: "AVG CORALL4 MIS", accessor: "AvgMissedCoralL4"}])) : setTableColumns(tableColumns.filter((x) => x.Header !== "AVG CORALL4 MIS"))}>AVG CORALL4 MIS</button>
    <button onClick={() => tableColumns.find((e) => e.Header === "AVG CORAL MIS") === undefined ? setTableColumns(tableColumns.concat([{Header: "AVG CORAL MIS", accessor: "AvgMissedCoral"}])) : setTableColumns(tableColumns.filter((x) => x.Header !== "AVG CORAL MIS"))}>AVG CORAL MIS</button>
    <button onClick={() => tableColumns.find((e) => e.Header === "AVG PRO MIS") === undefined ? setTableColumns(tableColumns.concat([{Header: "AVG PRO MIS", accessor: "AvgMissedProcessor"}])) : setTableColumns(tableColumns.filter((x) => x.Header !== "AVG PRO MIS"))}>AVG PRO MIS</button>
    <button onClick={() => tableColumns.find((e) => e.Header === "AVG NET MIS") === undefined ? setTableColumns(tableColumns.concat([{Header: "AVG NET MIS", accessor: "AvgMissedNet"}])) : setTableColumns(tableColumns.filter((x) => x.Header !== "AVG NET MIS"))}>AVG NET MIS</button>
    <button onClick={() => tableColumns.find((e) => e.Header === "AVG ALGAE MIS") === undefined ? setTableColumns(tableColumns.concat([{Header: "AVG ALGAE MIS", accessor: "AvgMissedAlgae"}])) : setTableColumns(tableColumns.filter((x) => x.Header !== "AVG ALGAE MIS"))}>AVG ALGAE MIS</button>
    <button onClick={() => tableColumns.find((e) => e.Header === "CORALL1 ACC") === undefined ? setTableColumns(tableColumns.concat([{Header: "CORALL1 ACC", accessor: "CoralL1Acc"}])) : setTableColumns(tableColumns.filter((x) => x.Header !== "CORALL1 ACC"))}>CORALL1 ACC</button>
    <button onClick={() => tableColumns.find((e) => e.Header === "CORALL2 ACC") === undefined ? setTableColumns(tableColumns.concat([{Header: "CORALL2 ACC", accessor: "CoralL2Acc"}])) : setTableColumns(tableColumns.filter((x) => x.Header !== "CORALL2 ACC"))}>CORALL2 ACC</button>
    <button onClick={() => tableColumns.find((e) => e.Header === "CORALL3 ACC") === undefined ? setTableColumns(tableColumns.concat([{Header: "CORALL3 ACC", accessor: "CoralL3Acc"}])) : setTableColumns(tableColumns.filter((x) => x.Header !== "CORALL3 ACC"))}>CORALL3 ACC</button>
    <button onClick={() => tableColumns.find((e) => e.Header === "CORALL4 ACC") === undefined ? setTableColumns(tableColumns.concat([{Header: "CORALL4 ACC", accessor: "CoralL4Acc"}])) : setTableColumns(tableColumns.filter((x) => x.Header !== "CORALL4 ACC"))}>CORALL4 ACC</button>
    <button onClick={() => tableColumns.find((e) => e.Header === "CORAL ACC") === undefined ? setTableColumns(tableColumns.concat([{Header: "CORAL ACC", accessor: "CoralAcc"}])) : setTableColumns(tableColumns.filter((x) => x.Header !== "CORAL ACC"))}>CORAL ACC</button>
    <button onClick={() => tableColumns.find((e) => e.Header === "PRO ACC") === undefined ? setTableColumns(tableColumns.concat([{Header: "PRO ACC", accessor: "ProcessorAcc"}])) : setTableColumns(tableColumns.filter((x) => x.Header !== "PRO ACC"))}>PRO ACC</button>
